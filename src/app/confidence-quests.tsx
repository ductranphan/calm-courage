/**
 * Confidence Quests screen.
 *
 * Matches Figma Screen 7.4:
 * - 30 mini-session cards
 * - reward statistics
...
/*
 * Fifteen rows of mini sessions.
 *
 * Footer space allows the final cards to scroll above the fixed navbar.
 */
...
const miniSessions = Array.from(
  ...
  (_, index) => {
    ...
    return {
      id: sessionNumber,
      label: `Mini Session\n${sessionNumber}`,
      accessibilityLabel: `Mini Session ${sessionNumber}`,
      left: isLeftColumn
        ? LEFT_COLUMN
        : RIGHT_COLUMN,
