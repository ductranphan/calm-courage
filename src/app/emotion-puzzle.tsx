/**
 * Emotion Puzzle Match activities screen.
 *
 * Matches Figma Screen 7.2:
 * - 20 activity cards
 * - reward statistics
...
/*
 * Footer space allows the final row to scroll above the fixed navbar.
 */
...
export default function EmotionPuzzleScreen() {
  ...
  const { completed: phaseCompleted } =
    useActivityCompleted(
      activeChild?.id,
      GAME_HUB_ACTIVITY_IDS.emotion_puzzle,
    );
